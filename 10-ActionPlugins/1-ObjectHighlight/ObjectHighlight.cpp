...
void ObjectHighlight::onPluginLoad()
{
	  QString vs_src =
    "#version 330 core\n"
...
void ObjectHighlight::preFrame()
{
	
}

void ObjectHighlight::postFrame()
{
	program->bind();
    GLWidget& g = *glwidget();
    g.makeCurrent();
...
void ObjectHighlight::onObjectAdd()
{
	
}

bool ObjectHighlight::drawScene()
{
	return false; // return true only if implemented
}

bool ObjectHighlight::drawObject(int)
{
	return false; // return true only if implemented
}

bool ObjectHighlight::paintGL()
{
	return false; // return true only if implemented
}

void ObjectHighlight::keyPressEvent(QKeyEvent *)
{
	
}

void ObjectHighlight::mouseMoveEvent(QMouseEvent *)
{
